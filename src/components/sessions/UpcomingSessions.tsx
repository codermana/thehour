    ...
    <section className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="space-y-4">
        {sessions.sort((a, b) => a.timestamp - b.timestamp ).map((session) => (
          <a href={session.slugPath} key={session.id} className="block bg-gray-50 dark:bg-zinc-900 rounded-xl p-6 border-l-4 border-codermana-orange hover:translate-x-2 transition-transform">
