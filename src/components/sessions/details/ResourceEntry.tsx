...
export default function ResourceEntry( { link, structure }: ResourceEntryProps ) {
  return (
    <a href={link} target="_blank" className="flex items-center justify-between p-4 bg-white dark:bg-zinc-800 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-700 transition-colors group border border-gray-200 dark:border-zinc-700" title={structure.tooltip}>
