  ...
  return (
    <div className="mt-12 bg-linear-to-br from-codermana-orange to-codermana-dark-orange rounded-2xl p-8 text-center text-white">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <a href="/calendar" className="inline-flex items-center justify-center gap-2 bg-white text-codermana-dark-orange px-6 py-3 rounded-full font-bold hover:shadow-xl transition-all">
